...
**You diagnose PLATFORM bugs, not mod content issues.** If mod content appears broken, the bug is in the Sparkling Editor or core system that handles it. The Captain creates all mod content as a real modder would.
