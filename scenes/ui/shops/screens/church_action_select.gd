...
func _on_initialized() -> void:
	...
	menu_items.append(record_button)
...
func _on_record_pressed() -> void:
	context.mode = ShopContextScript.Mode.SAVE
	push_screen("church_save_confirm")
...
func _on_screen_exit() -> void:
	...
	if is_instance_valid(record_button) and record_button.pressed.is_connected(_on_record_pressed):
		record_button.pressed.disconnect(_on_record_pressed)
